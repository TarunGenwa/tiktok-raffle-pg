  ...
  return (
    <div className="w-full flex flex-col bg-gradient-to-br from-gray-900 via-black to-gray-900 rounded-lg overflow-hidden relative max-w-full">
      ...
      <div className="relative z-10 flex flex-col p-4 sm:p-6">
        ...
        <button
          onClick={handleClick}
          className="w-full cursor-pointer p-[1.5px] md:p-[3px] rounded-xl sm:rounded-2xl bg-gradient-to-br from-emerald-500 via-green-500 to-teal-500 shadow-xl shadow-emerald-500/20 transform hover:scale-105 transition-transform cursor-pointer"
        >
